...
class PatientDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create patient_detail" do
    assert_difference("PatientDetail.count") do
      post patient_details_url, params: { patient_detail: { Age: @patient_detail.Age, Date: @patient_detail.Date, Grade: @patient_detail.Grade, Insurance: @patient_detail.Insurance, PID: @patient_detail.PID, PatientId: @patient_detail.PatientId, ProgramName: @patient_detail.ProgramName, SchoolName: @patient_detail.SchoolName } }
    end
  ...
  test "should update patient_detail" do
    patch patient_detail_url(@patient_detail), params: { patient_detail: { Age: @patient_detail.Age, Date: @patient_detail.Date, Grade: @patient_detail.Grade, Insurance: @patient_detail.Insurance, PID: @patient_detail.PID, PatientId: @patient_detail.PatientId, ProgramName: @patient_detail.ProgramName, SchoolName: @patient_detail.SchoolName } }
